...
%OpenCV1.1pre
OCVRoot = 'C:/OpenCV1.1/OpenCV';
IPath1 = ['-I',fullfile(OCVRoot,'cv/include')];
IPath2 = ['-I',fullfile(OCVRoot,'cvaux/include')];
IPath3 = ['-I',fullfile(OCVRoot,'cxcore/include')];
LPath = fullfile(OCVRoot, 'lib');
lib1 = fullfile(LPath,'cv.lib');
lib2 = fullfile(LPath,'cxcore.lib');
lib3 = fullfile(LPath,'highgui.lib');
lib4 = fullfile(LPath, 'cxcore.lib');

mex('surfpoints.cpp', IPath1, IPath2, IPath3, lib1, lib2, lib3, lib4);
...
//	FILE *textFile = fopen("C:/atad/research/experiment/SURF/SURFdetectingTime.txt", "a");
//	ofstream textFile; 
//	textFile.open("C:/atad/research/experiment/SURF/SURFdetectingTime.txt");
...
//	endTime("Converting image");
	...
	extractTime = endTime("# Extracting SURF features");

	
	// fahmi --write SURF feature extract time

//	char timeText[100] = {0};
//	sprintf(timeText, "%.06f\n", extractTime);
//	printf("èàóùéûä‘ÅF%.06f\n", extractTime);
//	fprintf(textFile, timeText);

//	textFile << extractTime << endl;
//	cout << "SURF features: " << n << endl;
//	cout << "### hacked!\n" << endl;
